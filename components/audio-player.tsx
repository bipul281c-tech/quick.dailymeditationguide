        ...
        <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="flex flex-col h-full justify-between py-2">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-medium text-stone-800 tracking-tight mb-1 line-clamp-2">
                {currentTrack.title}
              </h2>
              <p className="text-stone-500 text-sm mb-4">
                Guided by {currentTrack.artist} • {currentTrack.category}
              </p>
              <p className="text-stone-400 text-xs line-clamp-2 mb-4">{currentTrack.description}</p>
            </div>
